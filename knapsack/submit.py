...
try:
    pkg = __import__('dp_solver')
    if not hasattr(pkg, 'solve_it'):
        print 'the solve_it() function was not found in dp_solver.py'
        quit()
    solve_it = pkg.solve_it
except ImportError:
    print 'dp_solver.py was not found in the python path.'
    quit()
...
def output(part):
    ...
    try:
        ...
        print 'the solve_it(input_data) method from dp_solver.py raised an exception'
        print 'try testing it with python ./dp_solver.py before running this submission script'
        print 'exception message:'
        print e
        print ''
